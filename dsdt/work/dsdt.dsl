 ...
 *
 * Disassembly of orig/dsdt.aml, Thu Sep  8 22:39:07 2016
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001EAA6 (125606)
 *     Revision         0x02
 *     Checksum         0x75
 *     OEM ID           "INSYDE"
 *     OEM Table ID     "INSYDE"
 ...
 */
DefinitionBlock ("orig/dsdt.aml", "DSDT", 2, "INSYDE", "INSYDE", 0x00000003)
{
    ...
    OperationRegion (GNVS, SystemMemory, 0xBAFB9000, 0x0367)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (SDHB)
        {
            ...
            Device (RTL2)
            {
                ...
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If ((((BDID == One) || (BDID == 0x0B)) && (OSID == One)))
                    {
                        Return (0x0F)
                    }
        ...
        Device (I2C1)
        {
            ...
            Device (CAMF)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.PCI0.I2C1.CAMF.PLDB */
                }
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (WBUF) /* \_SB_.PCI0.I2C1.CAMF._CRS.WBUF */
                }
            ...
            Device (CAME)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.PCI0.I2C1.CAME.PLDB */
                }
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    Name (WBUF, ResourceTemplate ()
                    {
                        ...
                        I2cSerialBus (0x001B, ControllerInitiated, 0x00061A80,
                            AddressingMode7Bit, "\\_SB.PCI0.I2C1",
                            0x00, ResourceConsumer, ,
                            )
                    ...
                    Return (WBUF) /* \_SB_.PCI0.I2C1.CAME._CRS.WBUF */
                }
                ...
                Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
                {
                    ...
                    If ((Arg0 == ToUUID ("f486d39f-d657-484b-84a6-42a565712b92")))
                    {
                        Return (Buffer (0x20)
                        {
                            /* 0000 */  0x01, 0x00, 0x02, 0x00, 0x02, 0x01, 0x00, 0x00,  /* ........ */
                            /* 0008 */  0x05, 0x01, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00,  /* ........ */
                            /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* ........ */
                            /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00   /* ........ */
                        })
            ...
            Device (CAMB)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.PCI0.I2C1.CAMB.PLDB */
                }
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If ((OSID == One))
                    {
                        Return (WBUF) /* \_SB_.PCI0.I2C1.CAMB._CRS.WBUF */
                    }

                    Return (ABUF) /* \_SB_.PCI0.I2C1.CAMB._CRS.ABUF */
                }
        ...
        Device (I2C2)
        {
                                ...
                                While (One)
                                {
                                    ...
                                    ElseIf ((T_1 == 0x04))
                                    {
                                        Return (Buffer (0x54)
                                        {
                                            ...
                                            /* 0020 */  0x88, 0x88, 0x03, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* ........ */
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "ESSX8396")  // _HID: Hardware ID
                Name (_CID, "ESSX8396")  // _CID: Compatible ID
                Name (_DDN, "ES8396")  // _DDN: DOS Device Name
                Name (_UID, One)  // _UID: Unique ID
                Name (_PR0, Package (0x01)  // _PR0: Power Resources for D0
                {
                    CLK3
            ...
            Device (CAME)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.PCI0.I2C2.CAME.PLDB */
                }
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (WBUF) /* \_SB_.PCI0.I2C2.CAME._CRS.WBUF */
                }
            ...
            Device (CAMC)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.PCI0.I2C2.CAMC.PLDB */
                }
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (WBUF) /* \_SB_.PCI0.I2C2.CAMC._CRS.WBUF */
                }
        ...
        Device (I2C3)
        {
            ...
            Device (BMAA)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.PCI0.I2C3.BMAA._CRS.RBUF */
                }

                Method (ROTM, 0, Serialized)
                {
                    If ((VBTS == 0x0E))
                    {
                        ...
                        Return (RBUF) /* \_SB_.PCI0.I2C3.BMAA.ROTM.RBUF */
                    }
                     Return (RBUF) /* \_SB_.PCI0.I2C3.BMAA.ROTM.RBUF */
                }
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "KIOX0009")  // _HID: Hardware ID
                Name (_CID, "KIOX0009")  // _CID: Compatible ID
                ...
                Method (_CDM, 0, NotSerialized)  // _CDM: Clock Domain
                {
                    Local0 = 0x00ABCD05
                    Return (Local0)
                }
            ...
            Device (CAM5)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    Name (SBUF, ResourceTemplate ()
                    {
                        ...
                        I2cSerialBus (0x0056, ControllerInitiated, 0x00061A80,
                            AddressingMode7Bit, "\\_SB.PCI0.I2C4",
                            0x00, ResourceConsumer, ,
                            )
                        I2cSerialBus (0x0057, ControllerInitiated, 0x00061A80,
                            AddressingMode7Bit, "\\_SB.PCI0.I2C4",
                            0x00, ResourceConsumer, ,
                            )
                    })
        ...
        Device (I2C5)
        {
            ...
            Device (NFC2)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If ((OSID == 0x02))
                    {
                        Return (SBUF) /* \_SB_.PCI0.I2C5.NFC2._CRS.SBUF */
                    }

                    Return (GBUF) /* \_SB_.PCI0.I2C5.NFC2._CRS.GBUF */
                }
        ...
        Device (I2C6)
        {
            ...
            Device (TCSC)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (WBUF) /* \_SB_.PCI0.I2C6.TCSC._CRS.WBUF */
                }
        ...
        Scope (I2C3)
        {
            ...
            Device (STRB)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    Name (SBUF, ResourceTemplate ()
                    {
                        I2cSerialBus (0x0063, ControllerInitiated, 0x00061A80,
                            AddressingMode7Bit, "\\_SB.PCI0.I2C3",
                            0x00, ResourceConsumer, ,
                            )
                    })
    ...
    Scope (_SB)
    {
        ...
        Device (GPO1)
        {
            ...
            OperationRegion (USBN, SystemMemory, 0xFED9D008, 0x08)
            Field (USBN, DWordAcc, NoLock, Preserve)
            {
                USBE,   32
            }
            ...
            Method (_E05, 0, NotSerialized)  // _Exx: Edge-Triggered GPE
            {
                If ((BDID != One))
                {
                    ...
                    {
                        If (CondRefOf (\_SB.PCI0.I2C1.BATC))
                        {
        ...
        Device (GPO3)
        {
            ...
            Method (_E01, 0, NotSerialized)  // _Exx: Edge-Triggered GPE
            {
                ...
                If ((BDID == 0x08))
                {
                    If (CondRefOf (\_SB.PCI0.I2C7.BATC))
                    {
    ...
    Scope (_SB.PCI0.I2C1)
    {
        ...
        Device (BATC)
        {
            ...
            Method (_BIX, 0, NotSerialized)  // _BIX: Battery Information Extended
            {
                ...
                Divide (DSCP, 0x0A, , Local1)
                BIXP [0x06] = Local1
                Divide (DSCP, 0x14, , Local1)
                BIXP [0x07] = Local1
    ...
    Scope (_SB.PCI0.I2C7)
    {
        ...
        */
        ...
        Device (WIDR)
        {
            ...
            {
                ADBG ("SBTP WIDR")
                If (CondRefOf (\_SB.PCI0.I2C7.WIDR))
                {
            ...
            Method (PSOC, 0, NotSerialized)
            {
                ...
                If ((AVBL == One))
                {
                    Local1 = SOC /* \_SB_.PCI0.I2C7.WIDR.SOC */
                    Return (Local1)
                }
        ...
        Device (ADP1)
        {
            ...
            Method (_PSR, 0, Serialized)  // _PSR: Power Source
            {
                ...
                If ((BDID == One))
                {
                    ...
                    If ((PMID == 0x02))
                    {
                        If (CondRefOf (\_SB.PCI0.I2C7.BMDR))
                        {
                    ...
                    ElseIf (CondRefOf (\_SB.PCI0.I2C3.TIDR))
                    {
                ...
                ElseIf (CondRefOf (\_SB.PCI0.I2C1.BATC))
                {
